# Code taken from https://github.com/RuolinZheng08/twewy-discord-chatbot
# hosted on https://replit.com/@sadkitty08/EmpatheticChatbot#main.py
...
API_URL = 'https://api-inference.huggingface.co/models/cannice/'
...
class MyClient(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.content[0] == "$":
            ...
            bot_response = response.get('generated_text', None).replace("_comma_", ",")
...
def main():
    ...
    client = MyClient('blenderbot-400M-distill-empathetic')
