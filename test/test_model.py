...
from helper import get_mean, weighted_bleu_score, get_js_distance, load_empathy_classifier, load_emo_classifier, load_toxicity_classifier, emo_dis_bleu, append_scores
from torch.utils.data import DataLoader

# define which model to evaluate
text_generation_model = "ppo_model" # blenderbot, ppo_model
ppo_model = "./DEV_ppl_toxic_w4-4-2-emo-toxic-ppl-epoch1400-score0.21749959886074066-ppl4.019851207733154"
#"../DEV-mimic-lr-6-ppl-toxic-blenderbot-400m-emo-probi-ppl-last-score0.26038538995548793-ppl4.357065677642822"

# set path prefix
output_path_prefix = 'DEV_ppo_toxic-w4-4-2_test'
load_path_prefix = ''
...
with open(f'{output_path_prefix}_text_log_emo_probi_score.txt', 'w') as text_log:
    ...
    all_ref = prompts.append(targets_list)
    #bertscore_results = bertscore.compute(predictions=list_generated_texts, references=all_ref, lang="en")
